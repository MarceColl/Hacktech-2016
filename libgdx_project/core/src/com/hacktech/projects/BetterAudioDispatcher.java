 ...
 */
public class BetterAudioDispatcher implements Runnable {
    /**
     * Log messages.
     */
     ...
     */
    public BetterAudioDispatcher(final TarsosDSPAudioInputStream stream, final int audioBufferSize, final int bufferOverlap){
    ...
    private int readNextAudioBlock() throws IOException {
        ...
        if(!isFirstBuffer && audioFloatBuffer.length == floatOverlap + floatStepSize ){
            ...
            //audioFloatBuffer = new float[128];
			/*
